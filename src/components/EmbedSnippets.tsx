...
export default function EmbedSnippets({ url }: EmbedSnippetsProps) {
  ...
  const snippets = [
    {
      ...
      code: `![Minecraft Server Status](${url})`,
    },
    {
      label: 'HTML Embed',
      icon: <Terminal className="w-3.5 h-3.5 text-cyan-400" />,
      code: `<img src="${url}" alt="Minecraft Server Status" />`,
    },
    {
      label: 'BBCode (Forums)',
  ...
  return (
    <div className="bg-neutral-900 border border-neutral-800 p-6 rounded-lg mt-8">
      <h3 className="text-sm font-outfit font-bold text-neutral-200 uppercase mb-4 flex items-center gap-2 tracking-wider">
        ...
        Integration & Embedding Snippets
      </h3>
      <p className="text-xs text-neutral-400 mb-6 leading-relaxed">
        Use these dynamic snippets in your GitHub profile, server community websites, or forums. The image will load fresh Minecraft server status in real-time on every load!
      </p>
